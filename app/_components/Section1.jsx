    ...
    <div className='bg-[#399866] w-full max-w-[1024px] h-48 mt-32 mx-auto rounded-3xl'>
      <div className="flex justify-evenly items-center h-full mt-4"> 
        ...
        <div className='flex flex-col items-center'>
          ...
          <p className='text-white' style={{ fontFamily: "Times New Roman" }}>Project Completed</p>
        </div>
        ...
        <div className='flex flex-col items-center'>
          ...
          <p className='text-white' style={{ fontFamily: "Times New Roman" }}>Trusted Partner</p>
        </div>
        ...
        <div className='flex flex-col items-center'>
          ...
          <p className='text-white' style={{ fontFamily: "Times New Roman" }}>Money Donated</p>
        </div>
        ...
        <div className='flex flex-col items-center'>
          ...
          <p className='text-white' style={{ fontFamily: "Times New Roman" }}>Active Volunteer</p>
        </div>
      </div>
    </div>
  );
