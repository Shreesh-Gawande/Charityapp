  ...
  return (
    <div className='  mt-32 w-full'>
        <div className='flex flex-col items-center justify-evenly w-full gap-4'>
            <h1 className='text-4xl font-bold'style={{ fontFamily: "Manuale" }}>Urent Causes</h1>
            <p className=' text-xl'>Supporting urgent causes, changing lives.</p>
        </div>
      <div className='flex w-full  justify-evenly'>
      <div className='flex w-full max-w-[1024px] justify-between gap-8 mt-8'>
        <Card 
